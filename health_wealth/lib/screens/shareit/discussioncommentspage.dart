...
class DiscussionCommentsPage extends StatefulWidget {
  ...
  @override
  State<DiscussionCommentsPage> createState() => _CommentsPageState();
}

class _CommentsPageState extends State<DiscussionCommentsPage> {
    ...
    return Scaffold(
      ...
      body: Scaffold(
        body: StreamBuilder<QuerySnapshot>(
          stream: _db.getDiscussionCommentsSnapshot(widget.postId),
